...
(ert-deftest clojure-mode-syntax-table/oneword ()
  ...
  (should (eq (clojure-test-face-at 2 8   "(oneword/veryCom|pLex.stu-ff)")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 9 10  "(oneword/veryCom|pLex.stu-ff)")
              'default))
  (should (eq (clojure-test-face-at 11 28 "(oneword/veryCom|pLex.stu-ff)")
              'default))
  ...
  (should (eq (clojure-test-face-at 9 10  "(oneword/.veryCom|pLex.stu-ff)")
              'default))
  (should (eq (clojure-test-face-at 12 29 "(oneword/.veryCom|pLex.stu-ff)")
              'default)))
...
(ert-deftest clojure-mode-syntax-table/segment ()
  ...
  (should (eq (clojure-test-face-at 2 8   "(seg.mnt/veryCom|pLex.stu-ff)")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 9 10  "(seg.mnt/veryCom|pLex.stu-ff)")
              'default))
  (should (eq (clojure-test-face-at 11 28 "(seg.mnt/veryCom|pLex.stu-ff)")
              'default))
  ...
  (should (eq (clojure-test-face-at 9 10  "(seg.mnt/.veryCom|pLex.stu-ff)")
              'default))
  (should (eq (clojure-test-face-at 12 29 "(seg.mnt/.veryCom|pLex.stu-ff)")
              'default)))
...
(ert-deftest clojure-mode-syntax-table/camelcase ()
  ...
  (should (eq (clojure-test-face-at 2 8   "(CmlCase/veryCom|pLex.stu-ff)")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 9 10  "(CmlCase/veryCom|pLex.stu-ff)")
              'default))
  (should (eq (clojure-test-face-at 11 28 "(CmlCase/veryCom|pLex.stu-ff)")
              'default))
  ...
  (should (eq (clojure-test-face-at 9 10  "(CmlCase/.veryCom|pLex.stu-ff)")
              'default))
  (should (eq (clojure-test-face-at 12 29 "(CmlCase/.veryCom|pLex.stu-ff)")
              'default)))
...
(ert-deftest clojure-mode-syntax-table/mixedcase ()
  ...
  (should (eq (clojure-test-face-at 2 8   "(mxdCase/veryCom|pLex.stu-ff)")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 9 10  "(mxdCase/veryCom|pLex.stu-ff)")
              'default))
  (should (eq (clojure-test-face-at 11 28 "(mxdCase/veryCom|pLex.stu-ff)")
              'default))
  ...
  (should (eq (clojure-test-face-at 9 10  "(mxdCase/.veryCom|pLex.stu-ff)")
              'default))
  (should (eq (clojure-test-face-at 12 29 "(mxdCase/.veryCom|pLex.stu-ff)")
              'default)))

(ert-deftest clojure-mode-syntax-table/verycomplex ()
  :tags '(fontification syntax-table)
  (should (eq (clojure-test-face-at 3 21    "  veryCom|pLex.stu-ff") 'default))
  (should (eq (clojure-test-face-at 3 21    " @veryCom|pLex.stu-ff") 'default))
  (should (eq (clojure-test-face-at 3 21    " #veryCom|pLex.stu-ff") 'default))
  (should (eq (clojure-test-face-at 3 21    " .veryCom|pLex.stu-ff") 'default))
  (should (eq (clojure-test-face-at 3 21    "#^veryCom|pLex.stu-ff")
              'font-lock-type-face)) ;; type-hint
  (should (eq (clojure-test-face-at 3 21    " (veryCom|pLex.stu-ff)") 'default))

  (should (eq (clojure-test-face-at 3 21    " (veryCom|pLex.stu-ff/oneword)")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 22 22   " (veryCom|pLex.stu-ff/oneword)")
              'default))
  (should (eq (clojure-test-face-at 23 29   " (veryCom|pLex.stu-ff/oneword)")
              'default))

  (should (eq (clojure-test-face-at 3 21    " (veryCom|pLex.stu-ff/seg.mnt)")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 22 22   " (veryCom|pLex.stu-ff/seg.mnt)")
              'default))
  (should (eq (clojure-test-face-at 22 29   " (veryCom|pLex.stu-ff/seg.mnt)")
              'default))

  (should (eq (clojure-test-face-at 3 21    " (veryCom|pLex.stu-ff/mxdCase)")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 22 22   " (veryCom|pLex.stu-ff/mxdCase)")
              'default))
  (should (eq (clojure-test-face-at 22 29   " (veryCom|pLex.stu-ff/mxdCase)")
              'default))

  (should (eq (clojure-test-face-at 3 21    " (veryCom|pLex.stu-ff/CmlCase)")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 22 22   " (veryCom|pLex.stu-ff/CmlCase)")
              'default))
  (should (eq (clojure-test-face-at 22 29   " (veryCom|pLex.stu-ff/CmlCase)")
              'default))

  (should (eq (clojure-test-face-at
               3 21  " (veryCom|pLex.stu-ff/veryCom|pLex.stu-ff)")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at
               22 22 " (veryCom|pLex.stu-ff/veryCom|pLex.stu-ff)")
              'default))
  (should (eq (clojure-test-face-at
               23 41 " (veryCom|pLex.stu-ff/veryCom|pLex.stu-ff)")
              'default))
  ...
  (should (eq (clojure-test-face-at
              ...
              'default))
  (should (eq (clojure-test-face-at
               23 42 " (veryCom|pLex.stu-ff/.veryCom|pLex.stu-ff)")
              'default)))
...
(ert-deftest clojure-mode-syntax-table/kw-oneword ()
  ...
  (should (eq (clojure-test-face-at 3 9   "{:oneword/veryCom|pLex.stu-ff 0}")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 10 10 "{:oneword/veryCom|pLex.stu-ff 0}")
              'default))
  (should (eq (clojure-test-face-at 11 29 "{:oneword/veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face))
  ...
  (should (eq (clojure-test-face-at 10 10 "{:oneword/.veryCom|pLex.stu-ff 0}")
              'default))
  (should (eq (clojure-test-face-at 11 30 "{:oneword/.veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face)))
...
(ert-deftest clojure-mode-syntax-table/kw-segment ()
  ...
  (should (eq (clojure-test-face-at 3 9   "{:seg.mnt/veryCom|pLex.stu-ff 0}")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 10 10 "{:seg.mnt/veryCom|pLex.stu-ff 0}")
              'default))
  (should (eq (clojure-test-face-at 11 29 "{:seg.mnt/veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face))
  ...
  (should (eq (clojure-test-face-at 10 10 "{:seg.mnt/.veryCom|pLex.stu-ff 0}")
              'default))
  (should (eq (clojure-test-face-at 11 30 "{:seg.mnt/.veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face)))
...
(ert-deftest clojure-mode-syntax-table/kw-camelcase ()
  ...
  (should (eq (clojure-test-face-at 11 17 "{:CmlCase/mxdCase 0}")
              'clojure-keyword-face))
  (should (eq (clojure-test-face-at 3 9   "{:CmlCase/veryCom|pLex.stu-ff 0}")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 10 10 "{:CmlCase/veryCom|pLex.stu-ff 0}")
              'default))
  (should (eq (clojure-test-face-at 11 29 "{:CmlCase/veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face))
  ...
  (should (eq (clojure-test-face-at 10 10 "{:CmlCase/.veryCom|pLex.stu-ff 0}")
              'default))
  (should (eq (clojure-test-face-at 11 30 "{:CmlCase/.veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face)))
...
(ert-deftest clojure-mode-syntax-table/kw-mixedcase ()
  ...
  (should (eq (clojure-test-face-at 3 9   "{:mxdCase/veryCom|pLex.stu-ff 0}")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 10 10 "{:mxdCase/veryCom|pLex.stu-ff 0}")
              'default))
  (should (eq (clojure-test-face-at 11 29 "{:mxdCase/veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face))
  ...
  (should (eq (clojure-test-face-at 10 10 "{:mxdCase/.veryCom|pLex.stu-ff 0}")
              'default))
  (should (eq (clojure-test-face-at 11 30 "{:mxdCase/.veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face)))

(ert-deftest clojure-mode-syntax-table/kw-verycomplex ()
  :tags '(fontification syntax-table)
  (should (eq (clojure-test-face-at 3 9   " :veryCom|pLex.stu-ff")
              'clojure-keyword-face))
  (should (eq (clojure-test-face-at 3 9   "{:veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face))
  (should (eq (clojure-test-face-at 3 9   "{:#veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face))
  (should (eq (clojure-test-face-at 3 9   "{:.veryCom|pLex.stu-ff 0}")
  ...
  (should (eq (clojure-test-face-at 3 21  "{:veryCom|pLex.stu-ff/oneword 0}")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 22 22 "{:veryCom|pLex.stu-ff/oneword 0}")
              'default))
  (should (eq (clojure-test-face-at 23 29 "{:veryCom|pLex.stu-ff/oneword 0}")
              'clojure-keyword-face))

  (should (eq (clojure-test-face-at 3  9  "{:veryCom|pLex.stu-ff/seg.mnt 0}")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 22 22 "{:veryCom|pLex.stu-ff/seg.mnt 0}")
              'default))
  (should (eq (clojure-test-face-at 23 29 "{:veryCom|pLex.stu-ff/seg.mnt 0}")
              'clojure-keyword-face))

  (should (eq (clojure-test-face-at 3 9   "{:veryCom|pLex.stu-ff/CmlCase 0}")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 22 22 "{:veryCom|pLex.stu-ff/CmlCase 0}")
              'default))
  (should (eq (clojure-test-face-at 23 29 "{:veryCom|pLex.stu-ff/CmlCase 0}")
              'clojure-keyword-face))

  (should (eq (clojure-test-face-at 3 9   "{:veryCom|pLex.stu-ff/mxdCase 0}")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at 22 22 "{:veryCom|pLex.stu-ff/mxdCase 0}")
              'default))
  (should (eq (clojure-test-face-at 23 29 "{:veryCom|pLex.stu-ff/mxdCase 0}")
              'clojure-keyword-face))

  (should (eq (clojure-test-face-at
               3 21  "{:veryCom|pLex.stu-ff/veryCom|pLex.stu-ff 0}")
              'font-lock-type-face))
  (should (eq (clojure-test-face-at
               22 22 "{:veryCom|pLex.stu-ff/veryCom|pLex.stu-ff 0}")
              'default))
  (should (eq (clojure-test-face-at
               23 41 "{:veryCom|pLex.stu-ff/veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face))
  ...
  (should (eq (clojure-test-face-at
              ...
              'default))
  (should (eq (clojure-test-face-at
               23 42 "{:veryCom|pLex.stu-ff/.veryCom|pLex.stu-ff 0}")
              'clojure-keyword-face)))
